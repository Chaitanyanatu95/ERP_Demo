...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Table ID="displayMasterbatchTable" runat="server" HorizontalAlign="Center" CssClass="Table1">
     ...
     <asp:GridView ID="masterbatchGridView" runat="server" AutoGenerateColumns="False" ShowFooter="False" DataKeyNames="id"
                ...
                BackColor="#DFDDDD" BorderColor="black" BorderStyle="solid" BorderWidth="1px" CellPadding="4" CssClass="Table1" Width="70%" AllowPaging="true" PageSize="25" OnPageIndexChanging="masterbatchGridView_PageIndexChanging">
                <%-- Theme Properties --%>
