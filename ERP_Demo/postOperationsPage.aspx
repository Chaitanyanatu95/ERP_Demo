        ...
        <Columns>
                <asp:TemplateField HeaderText="TYPE" >
                    ...
                    <FooterTemplate>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Server=tcp:erppbp.database.windows.net,1433;Initial Catalog=Pbplastics;Persist Security Info=False;User ID=erppbp;Password=Pranav_1234;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [type] FROM [post_operation_master]">
                        </asp:SqlDataSource>
            ...
            <Columns>
                <asp:TemplateField HeaderText="PACKAGING TYPE" >
                    ...
                    <FooterTemplate>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Server=tcp:erppbp.database.windows.net,1433;Initial Catalog=Pbplastics;Persist Security Info=False;User ID=erppbp;Password=Pranav_1234;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [packaging_type] FROM [packaging_master]"></asp:SqlDataSource>
