...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Table ID="displayShiftTable" runat="server" HorizontalAlign="Center" CssClass="Table1">
     ...
     <asp:GridView ID="shiftGridView" runat="server" AutoGenerateColumns="False" ShowFooter="False" DataKeyNames="id"
                ...
                BackColor="#DFDDDD" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" CssClass="Table1" Width="30%" AllowPaging="true" OnPageIndexChanging="shiftGridView_PageIndexChanging" PageSize="15">
                <%-- Theme Properties --%>
