...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Table ID="Table1" runat="server" CssClass="tableClass" Height="40%" Width="30%">
        ...
        <asp:TableRow runat="server"><asp:TableCell runat="server"><div class="required" style="padding-left:12em">*</div><asp:TextBox ID="vendorEmailIdTextBox" runat="server"></asp:TextBox><br /><asp:RegularExpressionValidator ID="regexEmailValid" runat="server" ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ControlToValidate="customerEmailIdTextBox" CssClass="required" ErrorMessage="Please enter valid Email-Id"></asp:RegularExpressionValidator>
        ...
        <br /><asp:RequiredFieldValidator ID="vendorGstReq" CssClass="required" runat="server" ErrorMessage="Please enter GST NO." ControlToValidate="customerNameTextBox" SetFocusOnError="true"></asp:RequiredFieldValidator>
        <br />
