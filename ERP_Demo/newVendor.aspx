...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Table ID="Table1" runat="server" CssClass="tableClass" Height="40%" Width="30%">
        ...
        <asp:TableRow runat="server"><asp:TableCell runat="server"><div class="required" style="padding-left:12em">*</div><asp:TextBox ID="vendorContactNoTextBox" CssClass="marginTextBox" runat="server"></asp:TextBox><br /><asp:RequiredFieldValidator ID="vendorContactReq" CssClass="required" runat="server" ErrorMessage="please enter vendor contact no" ControlToValidate="vendorContactNoTextBox"></asp:RequiredFieldValidator></asp:TableCell></asp:TableRow>
        ...
        <asp:TableRow runat="server"><asp:TableCell runat="server"><div class="required" style="padding-left:12em">*</div><asp:TextBox ID="vendorEmailIdTextBox" CssClass="marginTextBox" runat="server"></asp:TextBox><br /><asp:RequiredFieldValidator ID="vendorEmailReq" CssClass="required" runat="server" ErrorMessage="please enter email ID" ControlToValidate="vendorEmailIdTextBox"></asp:RequiredFieldValidator></asp:TableCell></asp:TableRow>
        ...
        <asp:TableRow runat="server"><asp:TableCell runat="server"><div class="required" style="padding-left:12em">*</div><asp:TextBox ID="vendorGstDetailsTextBox" CssClass="marginTextBox" runat="server"></asp:TextBox>
        <br />
