     ...
     <asp:GridView ID="partsGridView" runat="server" AutoGenerateColumns="False" ShowFooter="True" DataKeyNames="id"
                ...
                <Columns>
                   ...
                   <asp:TemplateField HeaderText="More Details" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="19">
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:ImageButton ImageUrl="~/Images/edit.png" runat="server" CommandName="Fetch" ToolTip="Fetch" Width="20px" Height="20px" CommandArgument='<%#Eval("part_no")+","+ Eval("part_name")%>'/>
                            <asp:ImageButton ImageUrl="~/Images/delete.png" runat="server" CommandName="Delete" ToolTip="Delete" Width="20px" Height="20px" OnClientClick="Javascript: confirm('Are you sure?');" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
    </asp:GridView>
