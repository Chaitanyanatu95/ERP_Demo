<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="fpaReports.aspx.cs" Inherits="ERP_Demo.fpaReports" %>
    ...
    <html>
        ...
        <body>
            <table runat="server" class="tableClass" style="width:50%; height:70%">
                <tr>
                    <th runat="server" style="background-color:skyblue;text-align:center" colspan="7"><h3>FPA REPORTS</h3></th>
                </tr>
                <tr>
