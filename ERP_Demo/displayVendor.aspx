...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Table ID="displayVendorTable" runat="server" HorizontalAlign="Center" CssClass="Table1">
     ...
     <asp:GridView ID="vendorGridView" runat="server" AutoGenerateColumns="False" ShowFooter="False" DataKeyNames="id"
                ...
                BackColor="#DFDDDD" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" CellPadding="4" CssClass="Table1" Width="90%" AllowPaging="true" PageSize="15" OnPageIndexChanging="vendorGridView_PageIndexChanging">
                <%-- Theme Properties --%>
