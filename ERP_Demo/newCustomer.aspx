...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Table ID="Table1" runat="server" CssClass="tableClass" Width="30%">
        ...
        <asp:TableRow runat="server"><asp:TableCell runat="server"><div class="required" style="padding-left:12em">*</div><asp:TextBox TextMode="multiline" Columns="40" Rows="5" CssClass="marginTextBox"  ID="customerAddressOneTextBox" runat="server"></asp:TextBox><br /><asp:RequiredFieldValidator ID="customerAddressReq" CssClass="required" runat="server" ErrorMessage="Please enter address." ControlToValidate="customerAddressOneTextBox" SetFocusOnError="true"></asp:RequiredFieldValidator></asp:TableCell></asp:TableRow>
        ...
        <asp:TableRow runat="server"><asp:TableCell runat="server"><div class="required" style="padding-left:12em">*</div><asp:TextBox ID="customerEmailIdTextBox" CssClass="marginTextBox" runat="server"></asp:TextBox><br /><asp:RegularExpressionValidator ID="regexEmailValid" runat="server" ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ControlToValidate="customerEmailIdTextBox" CssClass="required" ErrorMessage="Invalid Email Format"></asp:RegularExpressionValidator>
        <asp:RequiredFieldValidator ID="customerEmailIdReq" CssClass="required" runat="server" ErrorMessage="Please enter email Id." ControlToValidate="customerEmailIdTextBox" SetFocusOnError="true"></asp:RequiredFieldValidator></asp:TableCell></asp:TableRow>
        ...
        <asp:TableRow runat="server"><asp:TableCell runat="server"><div class="required" style="padding-left:12em">*</div><asp:TextBox ID="customerGstDetailsTextBox" CssClass="marginTextBox" runat="server"></asp:TextBox>
        <br /><asp:RequiredFieldValidator ID="RequiredFieldValidator5" CssClass="required" runat="server" ErrorMessage="Please enter customer name." ControlToValidate="customerNameTextBox" SetFocusOnError="true"></asp:RequiredFieldValidator>
