    ...
    <asp:Table ID="Table1" runat="server" Height="70%" Width="80%" CssClass="tableClass">
        ...
        <asp:TableRow runat="server">
            <asp:TableCell runat="server" CssClass="margin">
                ...
                <asp:RequiredFieldValidator runat="server" ID="partNameReq" ControlToValidate="partNameTextBox" ErrorMessage="Please enter part name!" CssClass="required" /></asp:TableCell><asp:TableCell runat="server"  CssClass="margin">
                    ...
                    <asp:RequiredFieldValidator runat="server" ID="custNameReq" ControlToValidate="customerNameDropDownList" ErrorMessage="Please select customer name!" CssClass="required" /></asp:TableCell><asp:TableCell runat="server"  CssClass="margin">
                        <asp:TextBox ID="custPartNoTextBox" runat="server"></asp:TextBox><br />
                        <asp:RequiredFieldValidator runat="server" ID="custPartNoReq" ControlToValidate="custPartNoTextBox" ErrorMessage="Please enter customer part no!" CssClass="required" /></asp:TableCell></asp:TableRow><asp:TableRow runat="server">
            ...
            <asp:TableCell runat="server"  CssClass="margin">
                ...
                <asp:RequiredFieldValidator runat="server" ID="prodCategoryReq" ControlToValidate="familyDropDownList" ErrorMessage="Please select product category!" CssClass="required" /></asp:TableCell><asp:TableCell runat="server"  CssClass="margin">
                    <asp:TextBox ID="moldNameTextBox" runat="server"></asp:TextBox><br />
                    <asp:RequiredFieldValidator runat="server" ID="moldNameReq" ControlToValidate="moldNameTextBox" ErrorMessage="Please enter mold name!" CssClass="required" /></asp:TableCell><asp:TableCell runat="server"  CssClass="margin">
                        <asp:TextBox ID="moldYearTextBox" runat="server"></asp:TextBox></asp:TableCell><asp:TableCell runat="server"  CssClass="margin">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="moldLifeReq" ControlToValidate="moldLifeTextBox" ErrorMessage="Please enter mold life!" CssClass="required" /></asp:TableCell></asp:TableRow><asp:TableRow runat="server">
            ...
            <asp:TableCell runat="server"  CssClass="margin">
                ...
                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="noOfCavitiesTextBox" ErrorMessage="Please enter no of cavities!" CssClass="required" /></asp:TableCell><asp:TableCell runat="server"  CssClass="margin">
                    ...
                    <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator2" ControlToValidate="unitMeasurementDropDownList" ErrorMessage="Please select unit!" CssClass="required" /></asp:TableCell><asp:TableCell runat="server"  CssClass="margin">
                        <asp:TextBox ID="partWeightTextBox" runat="server"></asp:TextBox><br />
                        <asp:RequiredFieldValidator runat="server" ID="partWeightReq" ControlToValidate="partWeightTextBox" ErrorMessage="Please enter part weight!" CssClass="required" /></asp:TableCell><asp:TableCell runat="server"  CssClass="margin">
                            <asp:TextBox ID="shotWeightTextBox" runat="server"></asp:TextBox><br />
                            <asp:RequiredFieldValidator runat="server" ID="shotWeightReq" ControlToValidate="shotWeightTextBox" ErrorMessage="Please enter shot weight!" CssClass="required" /></asp:TableCell></asp:TableRow><asp:TableRow runat="server">
            <asp:TableCell runat="server"  CssClass="margin">CYC. TIME (sec)</asp:TableCell><asp:TableCell runat="server"  CssClass="margin">JIG/FIXTURE (REQ)</asp:TableCell><asp:TableCell runat="server"  CssClass="margin">PRODUCTION IN PCS (8HR) </asp:TableCell><asp:TableCell runat="server"  CssClass="margin"></asp:TableCell></asp:TableRow><asp:TableRow runat="server">
            <asp:TableCell runat="server"  CssClass="margin">
                ...
                <asp:RequiredFieldValidator runat="server" ID="cycleTimeReq" ControlToValidate="cycleTimeTextBox" ErrorMessage="Please enter cycle time!" CssClass="required" /></asp:TableCell><asp:TableCell runat="server"  CssClass="margin">
                    ...
                    <asp:TextBox ID="moldProductionCycleTextBox" runat="server" ReadOnly="true"></asp:TextBox></asp:TableCell><asp:TableCell runat="server"  CssClass="margin">
                        <asp:Button OnClick="NextPage_Click" runat="server" ID="nextPage" CssClass="nextPage" Text="NEXT"></asp:Button>
            ...
            <asp:TableCell runat="server"  CssClass="margin">
                ...
                ControlToValidate="moldSpecFileUpload" runat="server" ForeColor="Red" ErrorMessage="Please select a valid excel or .xls/.xlsx extension file."
                Display="Dynamic" />
