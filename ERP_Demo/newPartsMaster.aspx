...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Table ID="Table1" runat="server" Height="70%" Width="80%" CssClass="tableClass">
        ...
        <asp:TableRow ID="partId" runat="server" VerticalAlign="Bottom">
            <asp:TableCell runat="server" CssClass="margin">PART NO <div class="required" style="display:inline">*</div></asp:TableCell>
            <asp:TableCell runat="server" CssClass="margin">PART NAME <div class="required" style="display:inline">*</div></asp:TableCell>
            <asp:TableCell runat="server" CssClass="margin">CUSTOMER NAME <div class="required" style="display:inline">*</div></asp:TableCell>
        ...
        <asp:TableRow runat="server">
            ...
            <asp:TableRow runat="server">
            <asp:TableCell runat="server"  CssClass="margin">PRODUCT CATEGORY <div class="required" style="display:inline">*</div></asp:TableCell>
                <asp:TableCell runat="server"  CssClass="margin">MOLD NAME <div class="required" style="display:inline">*</div></asp:TableCell>
                <asp:TableCell runat="server"  CssClass="margin">MOLD MFG YEAR <div class="required" style="display:inline">*</div></asp:TableCell>
                <asp:TableCell runat="server"  CssClass="margin">MOLD LIFE IN NOS.</asp:TableCell></asp:TableRow>
        <asp:TableRow runat="server">
            <asp:TableCell runat="server"  CssClass="margin">
        ...
        <asp:TableRow runat="server">
            <asp:TableCell runat="server"  CssClass="margin">NO OF CAVITIES <div class="required" style="display:inline">*</div></asp:TableCell>
            <asp:TableCell runat="server"  CssClass="margin">UNIT <div class="required" style="display:inline">*</div></asp:TableCell>
            <asp:TableCell runat="server"  CssClass="margin">PART WEIGHT (In g) <div class="required" style="display:inline">*</div></asp:TableCell>
            <asp:TableCell runat="server"  CssClass="margin">SHOT WT ( in g) <div class="required" style="display:inline">*</div></asp:TableCell>
            </asp:TableRow>
        <asp:TableRow runat="server">
            <asp:TableCell runat="server"  CssClass="margin">
                ...
                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="noOfCavitiesTextBox" ErrorMessage="Please enter no of cavities!" CssClass="required" SetFocusOnError="true"/></asp:TableCell><asp:TableCell runat="server"  CssClass="margin">
                    ...
                    <asp:TableCell runat="server"  CssClass="margin">CYC. TIME (sec) <div class="required" style="display:inline">*</div></asp:TableCell><asp:TableCell runat="server" CssClass="margin">JIG/FIXTURE (REQ)</asp:TableCell>
                                <asp:TableCell runat="server"  CssClass="margin">PRODUCTION PER HOUR IN NOS. <div class="required" style="display:inline">*</div></asp:TableCell>
                                <asp:TableCell runat="server"  CssClass="margin">SAMPLE PART NO</asp:TableCell>
                    </asp:TableRow>
        <asp:TableRow runat="server">
            <asp:TableCell runat="server"  CssClass="margin">
                ...
                <asp:RequiredFieldValidator runat="server" ID="cycleTimeReq" ControlToValidate="cycleTimeTextBox" ErrorMessage="Please enter cycle time!" CssClass="required" SetFocusOnError="true" /></asp:TableCell>
                <asp:TableCell runat="server"  CssClass="margin">
            ...
            <asp:TableCell runat="server"  CssClass="margin">
                    <asp:TextBox ID="moldProductionCycleTextBox" runat="server" ReadOnly="true"></asp:TextBox>
            </asp:TableCell>
            <asp:TableCell runat="server"  CssClass="margin">
        ...
        <asp:TableRow runat="server">
            <asp:TableCell runat="server"  CssClass="margin">PHOTO <br /> Supported Formats: jpg,png,jpeg,gif</asp:TableCell>
            <asp:TableCell runat="server"  CssClass="margin">PROCESS SHEET <br /> Supported Formats: xls,csv,pdf</asp:TableCell>
