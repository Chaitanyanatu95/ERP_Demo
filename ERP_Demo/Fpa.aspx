...
<body>
    ...
    <table runat="server" class="tableClass" style="width:60%; height:70%">
        ...
        <tr>
            ...
            <td><input type="text" id="dateSelectionTextBox" runat="server" style="font-weight:700; color:black; text-align:center" size="10"/>
