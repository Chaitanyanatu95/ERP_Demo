...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Table ID="displayRawMaterialTable" runat="server" HorizontalAlign="Center" CssClass="Table1">
     ...
     <asp:GridView ID="rawMaterialGridView" runat="server" AutoGenerateColumns="False" ShowFooter="False" DataKeyNames="id"
                ...
                BackColor="#DFDDDD" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" CssClass="Table1" Width="70%" AllowPaging="true" PageSize="25" OnPageIndexChanging="rawMaterialGridView_PageIndexChanging">
                <%-- Theme Properties --%>
